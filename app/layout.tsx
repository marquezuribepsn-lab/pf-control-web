...
export default async function RootLayout({
  ...
  const links = [
    // ── MENU ──────────────────────────────────────────────────────────────
    { href: "/", label: "Inicio", section: "menu" as const },
    { href: "/clientes", label: "Plantel", section: "menu" as const },
    { href: "/semana", label: "Entrenamiento", section: "menu" as const },
    { href: "/asistencias", label: "Asistencias", section: "menu" as const },
    { href: "/alertas", label: "Avisos", section: "menu" as const },

    // ── Seccion secundaria, sin titulo ────────────────────────────────────
    { href: "/configuracion", label: "Config.", section: "extra" as const },
    { href: "/calendario", label: "Calendario", section: "extra" as const },
    { href: "/categorias", label: "Categor\u00edas", section: "extra" as const },

    // ── GRUPOS (admin) ────────────────────────────────────────────────────
    { href: "/categorias/Nutricion", label: "Nutrici\u00f3n", section: "grupos" as const, adminOnly: true },
    { href: "/admin/pagos", label: "Pagos", section: "grupos" as const, adminOnly: true },
    { href: "/clientes/musica", label: "M\u00fasica", section: "grupos" as const, adminOnly: true },
    { href: "/admin/whatsapp", label: "WhatsApp", section: "grupos" as const, adminOnly: true },
    { href: "/mensajes", label: "Mensajes", section: "grupos" as const, adminOnly: true },
    { href: "/equipos", label: "Equipos y Deportes", section: "grupos" as const, adminOnly: true },
    { href: "/admin/usuarios", label: "Usuarios", section: "grupos" as const, adminOnly: true },

    // ── Vista de alumno ───────────────────────────────────────────────────
    { href: "/alumnos/inicio", label: "Inicio", clientOnly: true },
    { href: "/alumnos/rutina", label: "Rutina", clientOnly: true },
    { href: "/alumnos/nutricion", label: "Plan nutricional", clientOnly: true },
    { href: "/alumnos/progreso", label: "Progreso", clientOnly: true },
    { href: "/alumnos/musica", label: "Musica", clientOnly: true },
  ];
  ...
  if (initialRole === "SUPERADMIN") {
    return (
      <html lang="es">
        <body className={`${bodyFont.variable} ${displayFont.variable} ${alumnoFont.variable} pf-v2 min-h-screen`}>
          <AuthSessionProvider>
            {children}
          </AuthSessionProvider>
        </body>
  ...
  return (
    <html lang="es">
      <body className={`${bodyFont.variable} ${displayFont.variable} ${alumnoFont.variable} min-h-screen pf-v2-s-deep pf-v2-t`}>
        <AuthSessionProvider>
          <PresenceBeacon />
