...
const TIPO_META: Record<NotifTipo, { label: string; icon: string; color: string }> = {
  novedad: { label: "Novedad", icon: "✨", color: "#a855f7" },
...
.pf-notif-bell {
  ...
  background: linear-gradient(135deg, rgba(124,58,237,0.22), rgba(30,20,55,0.55));
  color: #ede9fe; transition: transform .12s ease, background .2s ease;
}
.pf-notif-bell:hover { background: linear-gradient(135deg, rgba(124,58,237,0.36), rgba(30,20,55,0.7)); }
...
.pf-notif-badge {
  ...
  box-shadow: 0 0 0 2px rgba(10,6,20,0.9);
}
.pf-notif-backdrop {
  position: fixed; inset: 0; z-index: 2147482000; background: rgba(4,2,10,0.55);
  backdrop-filter: blur(2px);
}
.pf-notif-panel {
  position: fixed; z-index: 2147482001; top: 0; right: 0; height: 100dvh; width: min(420px, 100vw);
  background: #120b20; color: #ede9fe; display: flex; flex-direction: column;
  border-left: 1px solid rgba(168,85,247,0.22); box-shadow: -20px 0 60px rgba(0,0,0,0.5);
...
.pf-notif-title small { display: block; font-size: 11px; font-weight: 600; letter-spacing: .12em; text-transform: uppercase; color: #a78bfa; margin-bottom: 2px; }
.pf-notif-close { background: rgba(255,255,255,0.08); border: 0; color: #ede9fe; width: 32px; height: 32px; border-radius: 10px; cursor: pointer; font-size: 16px; }
...
.pf-notif-markall { background: none; border: 0; color: #a78bfa; font-size: 12px; font-weight: 700; cursor: pointer; padding: 4px 0; }
...
.pf-notif-tab { flex: 0 0 auto; border: 1px solid rgba(255,255,255,0.1); background: rgba(255,255,255,0.04); color: #cbb8f5; padding: 6px 12px; border-radius: 999px; font-size: 12px; font-weight: 700; cursor: pointer; white-space: nowrap; }
.pf-notif-tab.is-active { background: linear-gradient(135deg,#7c3aed,#a855f7); color: #fff; border-color: transparent; }
...
.pf-notif-item.is-unread { background: rgba(124,58,237,0.1); }
.pf-notif-item.is-unread:hover { background: rgba(124,58,237,0.16); }
...
.pf-notif-text { margin: 3px 0 0; font-size: 13px; color: #c7bde0; line-height: 1.4; }
.pf-notif-text.is-collapsed { display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
.pf-notif-dot { flex: 0 0 auto; width: 8px; height: 8px; border-radius: 50%; background: #a855f7; margin-top: 6px; }
.pf-notif-empty { text-align: center; padding: 60px 20px; color: #8b7fb0; }
